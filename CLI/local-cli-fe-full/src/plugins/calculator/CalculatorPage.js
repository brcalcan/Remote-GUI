...
const CalculatorPage = () => {
  ...
  const getV = async () => {
    ...
    const version = await ctx.services.api.getVersion();

    console.log(`Calc page version: ${JSON.stringify(version, null, 2)}`);
  };
          ...
          {result.error ? (
            ...
            <div>
              ...
              <p style={{ color: "#155724", margin: 0, fontSize: "18px" }}>
                {result.a} {getOperationSymbol(result.operation)} {result.b} ={" "}
